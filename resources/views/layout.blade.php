...
<head>
    ...
    <!-- morris CSS -->
    <link href="{{asset('front_assets/plugins/morrisjs/morris.css')}}" rel="stylesheet">
    <!-- Custom CSS -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Auction </span></a>
...
@yield('content')
    ...
    <!--morris JavaScript -->
    <script src="{{asset('front_assets/')}}../assets/plugins/raphael/raphael-min.js"></script>
    <script src="{{asset('front_assets/plugins/morrisjs/morris.min.js')}}"></script>
    <!-- Chart JS -->
    <script src="{{asset('front_assets/js/dashboard1.js')}}"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
